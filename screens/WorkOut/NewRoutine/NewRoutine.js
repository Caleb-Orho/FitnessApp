...
export default function NewRoutine({ navigation }) {
    ...
    const [timePick, setTimePicker] = useState({
        isOpen: false,
        exerciseName: '', // You might want to set a default exerciseName or leave it empty
    });
    ...
    const save = async () => {
        ...
        try {
            ...
            const fileUri = directoryUri + routineTitle.replace(" ", "") + '.json';
        ...
        <View className="h-full px-5">
            ...
            <ScrollView >
                ...
                <Alerts
                    ...
                    title="Routine Title Cannot Be Empty"
